...
const CoursesList = () => {
  ...
  return (
    <>
    <div className='relative md:px-36 px-6 pt-18 pb-1.5 text-left'>
      ...
      { input && <div className='inline-flex items-center gap-4 px-4 py-2 border mt-6 mb-1 text-gray-400'>
        <p>{input}</p>
