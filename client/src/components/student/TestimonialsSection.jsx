...
const TestimonialsSection = () => {
  return (
    <div className='pb-14 px-8 md:px-0'>
      ...
      <p className='md:text-base text-gray-500 mt-3'>Discover the stories of learners who transformed their skills,
       reached new goals, and <br />found real value through our platform.</p>
           ...
           shadow-[0px_4px_15px_0px] shadow-black/5 overflow-hidden'>
            <div className='flex items-center gap-4 px-5 py-4 bg-gray-500/10'>
              ...
              <div>
                ...
                <p className='text-shadow-gray-800/80 '>{testimonial.role}</p>
              </div>             
            </div>
